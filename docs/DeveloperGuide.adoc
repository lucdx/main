...
.. Test case: `add John Doe p/98765432 e/johnd@gmail.com a/311, Clementi Ave 2, #02-25 t/friends t/owesMoney` after the previous test case was performed. +
   Expected: No person is added. Error details shown in the status console. Output console remains the same.
...
.. Test case: `regexam 1 1` after the previous test case was performed. +
   Expected: Exam is not added. Error details shown in the status console. Output console remains the same.
...
.. Test case: `deregexam 1 1` after the previous test case was performed. +
   Expected: Exam is not removed. Error details shown in the status console. Output console remains the same.
...
.. Test case: `editexam 1 p/n` after the previous test case was performed. +
   Expected: Exam is not edited. Error details shown in the status console. Output console remains the same.
   
=== Viewing exams as a student

. View non-private exams in a student account

.. Prerequisites: Logged in with a student account of the 1st person in the AddressBook. AddressBook has mutiple persons.

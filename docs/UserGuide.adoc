...
==== List all fees of every person : `listfees`  image:Admin.png[16,16]
...
==== List only people with due fees : `listdue`  image:Admin.png[16,16]
...
Adds a "overdue" tag to the people shown for easier tracking in the future.
****
